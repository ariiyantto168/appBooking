              ...
              @if (Auth::user()->role_type == "A")
                  <li class="treeview" id="menu_master">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li id="submenu_asuransi"><a href="{{url('asuransi')}}"><i class="fa fa-users"></i> Asuransi</a></li>
                      <li id="submenu_kantor"><a href="{{url('kantor')}}"><i class="fa fa-users"></i> kantor cabangs</a></li>  
                      <li id="submenu_bangunan"><a href="{{url('bangunan')}}"><i class="fa fa-users"></i> Bangunan</a></li>  -->
                      <li id="submenu_tipe"><a href="{{url('tipe')}}"><i class="fa fa-users"></i> Tipe</a></li>
                      <li id="submenu_internal"><a href="{{url('internal')}}"><i class="fa fa-users"></i> Fasilitas Internal</a></li>
                      <li id="submenu_external"><a href="{{url('external')}}"><i class="fa fa-users"></i> Fasilitas External</a></li> 
                ...
                @endif
                @if (Auth::user()->role_type == "P")
                <li id="menu_orders"><a href="{{url('orders/create-new')}}"><i class="fa fa-first-order"></i> <span>Orders</span></a></li>
                <li id="menu_orders"><a href="{{url('orders/')}}"><i class="fa fa-first-order"></i> <span>History</span></a></li>
